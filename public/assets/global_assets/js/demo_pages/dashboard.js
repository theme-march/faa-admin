 ...
 *
 *  Demo prescription configuration. Contains charts and plugin initializations
 *
 * ---------------------------------------------------------------------------- */
...
var Dashboard = function () {
    ...
    var _TrafficSourcesStreamChart = function(element, height) {
        ...
        if($(element).length > 0) {
            ...
            d3.csv('../../../../global_assets/demo_data/prescription/traffic_sources.csv', function (error, data) {
    ...
    var _AppSalesLinesChart = function(element, height) {
        ...
        if($(element).length > 0) {
            ...
            d3.csv('../../../../global_assets/demo_data/prescription/app_sales.csv', function(error, data) {
                formatted = data;
                redraw();
            });
    ...
    var _MonthlySalesAreaChart = function(element, height, color) {
        ...
        if($(element).length > 0) {
            ...
            d3.json('../../../../global_assets/demo_data/prescription/monthly_sales.json', function (error, data) {
    ...
    var _AppSalesHeatmap = function(element) {
        ...
        if($(element).length > 0) {
            ...
            // Load data
            d3.csv('../../../../global_assets/demo_data/prescription/app_sales_heatmap.csv', function(error, data) {
    ...
    var _BulletChart = function(element, height) {
        ...
        if($(element).length > 0) {
            ...
            d3.json('../../../../global_assets/demo_data/prescription/bullets.json', function(error, data) {
